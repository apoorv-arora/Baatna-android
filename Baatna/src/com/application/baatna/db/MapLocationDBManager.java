...
public class MapLocationDBManager extends SQLiteOpenHelper {
	...
	private static final String CACHE_TABLE_NAME = "MAPLOCATIONS";
	...
	private static final String DATABASE_NAME = "MAPLOCATIONSDB";
	Context ctx;

	public MapLocationDBManager(Context context) {
		super(context, DATABASE_NAME, null, DATABASE_VERSION);
		ctx = context;
	}

	public MapLocationDBManager(Context context, String name,
	...
	public ArrayList<BLocation> getLocations(int cityId, int userId) {
		...
		try {
			...
			cursor = db.query(CACHE_TABLE_NAME, new String[] { ID, USERID,
					TIMESTAMP, TYPE, BUNDLE }, /* CITYID + "=? AND " + */
					USERID + "=?",
					new String[] { /* Integer.toString(cityId), */Integer
							.toString(userId) }, null, null, TIMESTAMP
							+ " DESC", "20");
			if (cursor != null)
				cursor.moveToFirst();
