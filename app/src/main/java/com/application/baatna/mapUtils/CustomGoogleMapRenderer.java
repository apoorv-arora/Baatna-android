 ...
 */
public class CustomGoogleMapRenderer implements ClusterRenderer<SimpleRestaurantPin> {
   ...
   public CustomGoogleMapRenderer(Context context, GoogleMap map, ClusterManager clusterManager) {
        mMap = map;
    ...
    private class RenderTask implements Runnable {
        ...
        @SuppressLint("NewApi")
        public void run() {
            if (clusters.equals(CustomGoogleMapRenderer.this.mClusters)) {
                mCallback.run();
                return;
            }
            ...
            if (CustomGoogleMapRenderer.this.mClusters != null && SHOULD_ANIMATE) {
                existingClustersOnScreen = new ArrayList<Point>();
                for (Cluster<SimpleRestaurantPin> c : CustomGoogleMapRenderer.this.mClusters) {
...
//                }
            ...
            mMarkers = newMarkers;
            CustomGoogleMapRenderer.this.mClusters = clusters;
            mZoom = zoom;
