...
//			get.addHeader(new BasicHeader("Authorization", "Basic emRldjpvSnU0Rm9oY2hvb20zY2hhPWcmbw==")); //ZDEV new
//		else
...
//		if(CommonLib.isTestBuild)
//			post.addHeader(new BasicHeader("Authorization", "Basic emRldjpvSnU0Rm9oY2hvb20zY2hhPWcmbw==")); //ZDEV new
//		else
