...
public class StickyHeaderWrapperExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public StickyHeaderWrapperExpandableListAdapter(ExpandableListAdapter adapter) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if(convertView != null) {
            final Object tag = convertView.getTag(R.id.sticky_header_list_tag_changed_visibility);
            ...
            convertView.setTag(R.id.sticky_header_list_tag_changed_visibility, null);
        }
