...
public class RoundedDrawable extends Drawable {
	...
	public static final int TYPE_ROUNDED_TOP = 1;
	public static final int TYPE_ROUNDED_ALL = 2;
	...
	public RoundedDrawable setLayoutWidth(int layoutWidth) {
	...
	public RoundedDrawable setLayoutHeight(int layoutHeight) {
	...
	public void draw(Canvas canvas) {
		...
		if (mOval) {
			...
			if (mBorderWidth > 0) {
				...
				if(getType() == TYPE_ROUNDED_TOP) {
					canvas.drawRoundRect(mDrawableRect, mCornerRadius, mCornerRadius, mBitmapPaint);
					final RectF rectBottom = new RectF(0, mCornerRadius, getLayoutWidth(), getLayoutHeight()); 
					canvas.drawRect(rectBottom, mBitmapPaint);}
				else if(getType() == TYPE_ROUNDED_ALL) {
					canvas.drawRoundRect(mDrawableRect, mCornerRadius, mCornerRadius, mBitmapPaint);	
				}
			}
		}
